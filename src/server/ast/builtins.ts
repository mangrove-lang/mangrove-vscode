...
[
	...
	new MangroveSymbol('Int8', new SymbolType(SymbolTypes.type | SymbolTypes.integer | SymbolTypes.int8Bit)),
	new MangroveSymbol('Int16', new SymbolType(SymbolTypes.type | SymbolTypes.integer | SymbolTypes.int16Bit)),
	new MangroveSymbol('Int32', new SymbolType(SymbolTypes.type | SymbolTypes.integer | SymbolTypes.int32Bit)),
	new MangroveSymbol('Int64', new SymbolType(SymbolTypes.type | SymbolTypes.integer | SymbolTypes.int64Bit)),
